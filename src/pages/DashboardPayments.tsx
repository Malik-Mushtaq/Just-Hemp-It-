    ...
    <DashboardPanel>
      <div className="space-y-3">
        {cards.map((card) => (
          <div
            key={card.last4}
            className="flex flex-wrap items-center justify-between gap-3 rounded-[20px] border border-[#ddceb5] bg-[#fffdf7] px-4 py-4"
          >
      ...
      <Button
        variant="outline"
        className="mt-4 rounded-full border-[#d8c8ac] bg-[#fffdf7] text-[#5a4a3a]"
      >
